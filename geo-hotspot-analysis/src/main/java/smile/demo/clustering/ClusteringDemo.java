...
public abstract class ClusteringDemo extends JPanel implements Runnable, ActionListener, AncestorListener {
    ...
    public ClusteringDemo() {
        if (dataset == null) {
            ...
            parser.setDelimiter("[, ]+");
            try {
                AttributeDataset data = parser.parse("id_long_lat", new FileInputStream(new File("/mnt/1717A37A1971CE02/WorkSpaces/BDMA/data-mining/DataMining_BDMA/input_data/accidents_2012_to_2014.csv100000")));
